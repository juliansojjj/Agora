...
@Component({
    ...
    template: `
  <div class="w-full xl:grid xl:grid-cols-[9%_82%_9%] min-h-[86vh] flex flex-col max-xl:items-center md:pt-6 xl:px-0 sm:px-6 px-0">
    <div></div>
    ...
    <div class="flex flex-col max-sm:items-center">
      ...
      <section class="sm:w-full w-[95%] h-fit pt-20 flex">
