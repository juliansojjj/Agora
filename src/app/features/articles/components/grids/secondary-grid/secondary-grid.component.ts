      ...
      grid-cols-1 gap-y-[2rem]">
        ...
        flex flex-col" >
          <div class="w-full lg:h-full sm:h-[10rem] xsm:h-[12rem] h-[9rem] bg-black overflow-hidden">   
            ...
            <div class="w-full lg:h-full sm:h-[10rem] xsm:h-[8rem] h-[11rem] p-3 " [ngClass]="cellHover() == '1' ? 'text-white bg-black' : 'bg-white'"> 
        ...
        <div class="w-full h-[20rem] flex md:flex-row flex-col items-end relative">
          @for (item of articles().slice(2,5); track $index) {
            @if($index == 0){
              ...
              class="w-full h-full bg-white hover:bg-brandGrey p-1 sm:p-3 sm:border-0 border-t-2 border-black">
