...
@Component({
  ...
  template: `
    <header
      class="w-full  flex flex-col justify-between  items-center top-0 left-0 z-10  h-[11rem]  "
      [ngClass]="banner() ? 'fixed' : 'sticky bg-white'"
    >
      <nav class="w-full flex justify-center">
          <ul
          class=" w-full lg:w-3/5 relative grid grid-cols-[1fr_1fr_1fr] pt-6 h-[8.5rem]" 
        ...
        >
          ...
          <li class="mx-auto">
            <a routerLink="/">
              <img
                src="agora-logo.svg" class="h-[5.5rem]"
              />
            </a>
          </li>
